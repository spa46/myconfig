...
"            |_|
"
"   sThis is the personal .vimrc file of Steve Francia.
...
" Vimdiff {
    if &diff
        au FilterWritePre * if &diff | colorscheme aqua | endif
    endif
" }
...
" Formatting {
    ...
    autocmd FileType arxml setlocal foldmethod=indent
...
" Plugins {
    ...
    " indent_guides {
        if isdirectory(expand("~/.vim/bundle/vim-indent-guides/"))
            ...
            "let g:indent_guides_enable_on_vim_startup = 1 " tab highlighting
...
"source ~/.vim/vim-bitbake/plugin/newbb.vim
"source ~/.vim/vim-bitbake/ftplugin/bitbake.vim
